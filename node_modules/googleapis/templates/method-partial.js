...
{%
    -set
    pathParams = m.parameters | getPathParams - %
}
/**
 * {{ m.id }}
 *
...
function (params, callback) {
    var parameters = {
        options: {
            url: {
    {
        (rootUrl + servicePath + m.path) | buildurl
    }
},
    method: '{{ m.httpMethod }}'
},
    ...
    mediaUrl: {
        {
            [rootUrl, m.mediaUpload.protocols.simple.path] | join('') | buildurl
        }
    }
,
    {%
